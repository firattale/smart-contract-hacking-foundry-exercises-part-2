...
contract FindMe {
    ...
    function claim(string memory solution) public {
        require(hash == keccak256(abi.encodePacked(solution)), "Incorrect response");
    ...
    function funnyFunction() public pure returns (string memory) {
        return "I am a funny function, I am not used for anything, I am just here to make you laugh";
    }
    ...
    function complicateFunction() public pure returns (string memory) {
        ...
        return "I am a complicate function, I am not used for anything, I am just here to make you cry";
    }
