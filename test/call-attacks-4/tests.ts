...
describe('Calls Attacks Exercise 4', function () {
	...
	before(async function () {
		...
		blockSafe1 = (await ethers.getContractAt('src/call-attacks-4/BlockSafe.sol:BlockSafe', blockSafe1Address)) as unknown as BlockSafe;
		...
		blockSafe2 = (await ethers.getContractAt('src/call-attacks-4/BlockSafe.sol:BlockSafe', blockSafe2Address)) as unknown as BlockSafe;
		...
		blockSafe3 = (await ethers.getContractAt('src/call-attacks-4/BlockSafe.sol:BlockSafe', blockSafe3Address)) as unknown as BlockSafe;
